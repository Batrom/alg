    ...
    static class Matcher {
        ...
        private void findAllPossibleMeetingsConfigurations() {
            while (currentMaxIndex < pairs.size()) {
                ...
                for (final var snapshot : List.copyOf(snapshots)) {
                    matchRecursively(index, snapshot.meetings(), snapshot.usersTimeslots(), snapshot.companiesTimeslots(), snapshot.timeslotsRoomsCount());
                }
